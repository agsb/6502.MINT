...
### Code Design
   ...
   - the code was not ordered into pages of 256 bytes, the addresses of the routines were organized into lists of "low bytes and high bytes", for fast parallel query. Almost 256 references be stored.
